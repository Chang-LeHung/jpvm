...
import org.jpvm.excptions.jobjs.PyUnsupportedOperator;
...
public class PyListObject extends PyObject
  ...
  public static final PyTypeType type = new PyListType();
  ...
  public class PyListItrObject extends PyObject implements TypeDoIterate {
    ...
    public static final PyTypeType type = new PyListItrType();
    private int idx;
