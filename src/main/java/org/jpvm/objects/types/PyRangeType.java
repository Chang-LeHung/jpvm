    ...
    if (args.size() == 1) {
      ...
      if (!(object instanceof PyLongObject o))
        return PyErrorUtils.pyErrorFormat(PyErrorUtils.TypeError,
            "PyRangeType require int as 1st parameter");
      ...
      if (!(object instanceof PyLongObject o2))
        return PyErrorUtils.pyErrorFormat(PyErrorUtils.TypeError,
            "PyRangeType require int as 2nd parameter");
      if (o1.getData() > o2.getData())
        return PyErrorUtils.pyErrorFormat(PyErrorUtils.TypeError,
            "PyRangeType require start less than end");
      ...
      if (!(object instanceof PyLongObject o3))
        return PyErrorUtils.pyErrorFormat(PyErrorUtils.TypeError,
            "PyRangeType require int as 3rd parameter");
