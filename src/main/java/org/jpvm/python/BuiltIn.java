...
public class BuiltIn {
  ...
  public static void doInit() {
    ...
    try {
      ...
      mp = new PyNativeMethodObject(clazz.getMethod("any", PyTupleObject.class, PyDictObject.class), true);
      dict.put(PyUnicodeObject.getOrCreateFromInternStringPool("any", true), mp);
      mp = new PyNativeMethodObject(clazz.getMethod("all", PyTupleObject.class, PyDictObject.class), true);
      dict.put(PyUnicodeObject.getOrCreateFromInternStringPool("all", true), mp);
